...
(function() {
  var HebrewDate, HebrewMonth, HebrewYear, Molad, RoshHashana, Sedra, leapMonthsElapsedInCurrent19YearCycle, leapMonthsInHistory, positive_modulus,
  ...
  HebrewDate = (function() {
    ...
    HebrewDate.prototype.monthAndRangeAre = function(month, range) {
      var _ref;
      return this.staticHebrewMonth === HebrewMonth[month] && (_ref = this.dayOfMonth, __indexOf.call(range, _ref) >= 0);
    };
    ...
    HebrewDate.prototype.isChanukkah = function() {
      ...
      return this.monthAndRangeAre('KISLEV', [25, 26, 27, 28, 29, 30]) || this.monthAndRangeAre('TEVET', (function() {
        _results = [];
        for (var _i = 1, _ref = (this.hebrewYear.getDaysInYear() % 10 > 3 ? 2 : 3); 1 <= _ref ? _i <= _ref : _i >= _ref; 1 <= _ref ? _i++ : _i--){ _results.push(_i); }
        return _results;
      }).apply(this));
    };
    ...
    HebrewDate.prototype.isRoshHodesh = function() {
      var _ref;
      return ((_ref = this.dayOfMonth) === 1 || _ref === 30) && this.staticHebrewMonth !== HebrewMonth.TISHRI;
    };
    ...
    HebrewDate.prototype.isShabbatMevarechim = function() {
      var _ref;
      return (_ref = this.dayOfMonth, __indexOf.call([23, 24, 25, 26, 27, 28, 29], _ref) >= 0) && this.isShabbat() && !this.inElul();
    };
    ...
    HebrewDate.prototype.isErubTabshilin = function() {
      var _ref;
      return this.isErebYomTob() && ((_ref = this.gregorianDate.getDay()) === 3 || _ref === 4);
    };
    ...
    HebrewDate.prototype.occasions = function() {
      var alias, chag, result, val, _ref;
      result = [];
      for (chag in this) {
        val = this[chag];
        if (chag.match(/^is/) && this[chag]() && !(_ref = this[chag], __indexOf.call((function() {
          var _i, _len, _results;
          _results = [];
          for (_i = 0, _len = result.length; _i < _len; _i++) {
            alias = result[_i];
            _results.push(this["is" + alias]);
          }
          return _results;
        }).call(this), _ref) >= 0)) {
  ...
  (function() {
    ...
    return this.NAMES = (function() {
      ...
      _ref = this.MONTHS.PESHUTA;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        month = _ref[_i];
        _results.push(month.name);
      }
      return _results;
    }).call(this);
  }).call(HebrewMonth);
  ...
  HebrewYear = (function() {
    ...
    HebrewYear.prototype.isLeapYear = function() {
      var _ref;
      return (_ref = this.daysInYear) === 383 || _ref === 384 || _ref === 385;
    };
  ...
  */
  ...
  RoshHashana = (function() {
    ...
    function RoshHashana(hebrewYear) {
      var dayOfWeek, halakim, _ref, _ref1, _ref2;
      ...
      this.isLeapYear = (_ref = hebrewYear % 19, __indexOf.call(RoshHashana.GUCHADZAT, _ref) >= 0);
      this.followsLeapYear = (_ref1 = (hebrewYear - 1) % 19, __indexOf.call(RoshHashana.GUCHADZAT, _ref1) >= 0);
      dayOfWeek = this.gregorianDateOfMolad.getDay();
      this.dehiyot = new Array();
      this.gregorianDate = new Date(this.gregorianDateOfMolad);
      if (__indexOf.call(RoshHashana.ADU, dayOfWeek) >= 0) {
        ...
        if (1 === this.dehiyot.length && (_ref2 = (dayOfWeek + 1) % 7, __indexOf.call(RoshHashana.ADU, _ref2) >= 0)) {
          this.dehiyot.push('ADU');
        }
      }
